...
## Model Overview
**Base Model:** The pipeline leverages the https://huggingface.co/l3cube-pune/marathi-roberta, a BERT-based transformer model pre-trained on Marathi text data.
